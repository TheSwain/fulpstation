...
/obj/item/clothing/under/gnome
	...
	icon = 'icons/fulpicons/halloween_costumes/2020/gnome_item.dmi'
	worn_icon = 'icons/fulpicons/halloween_costumes/2020/gnome_worn.dmi'
...
/obj/item/clothing/head/gnome/proc/triggered(mob/target)
	...
	playsound(src, 'sound/Fulpsounds/gnomed.ogg', 50, TRUE)
	armed = FALSE
	update_icon()
