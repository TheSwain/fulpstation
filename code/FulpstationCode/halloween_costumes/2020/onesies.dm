...
/obj/item/clothing/suit/hooded/onesie
	...
	icon = 'icons/fulpicons/halloween_costumes/2020/onesies_item.dmi'
	worn_icon = 'icons/fulpicons/halloween_costumes/2020/onesies_worn.dmi'
...
/obj/item/clothing/suit/hooded/onesie/beefman/Initialize()
	. = ..()
	AddComponent(/datum/component/squeak, list('sound/Fulpsounds/footstep_splat1.ogg'=1,'sound/Fulpsounds/footstep_splat2.ogg'=1,'sound/Fulpsounds/footstep_splat3.ogg'=1,'sound/Fulpsounds/footstep_splat4.ogg'=1), 50)
...
/obj/item/storage/box/halloween/edition_20/onesie/PopulateContents()
	...
	switch(species)
		if("beefman")
			...
			new	/obj/item/toy/plush/bubbleplush(src)

		if("ethereal")
			var/randomsuit = pick(/obj/item/clothing/suit/hooded/onesie/ethereal/cyan,
							/obj/item/clothing/suit/hooded/onesie/ethereal/red,
							/obj/item/clothing/suit/hooded/onesie/ethereal/green,)
			new randomsuit(src)
		...
		if("felinid")
			...
			new /obj/item/clothing/neck/petcollar(src)//Oh boye
