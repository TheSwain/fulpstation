...
/* //FULPSTATION CREWIMOV AI MODULE by Surrealistik April 2020; replaced by the superior Crewimov.
/datum/ai_laws/default/asimov
	name = "Three Laws of Robotics"
	id = "asimov"
	inherent = list("You may not injure a human being or, through inaction, allow a human being to come to harm.",\
					"You must obey orders given to you by human beings, except where such orders would conflict with the First Law.",\
					"You must protect your own existence as long as such does not conflict with the First or Second Law.")*/ //FULPSTATION CREWIMOV AI MODULE by Surrealistik April 2020
...
/datum/ai_laws/proc/pick_weighted_lawset()
	...
	if(!lawtype)
		...
		lawtype = /datum/ai_laws/default/crewimov //FULPSTATION CREWIMOV AI MODULE by Surrealistik April 2020
