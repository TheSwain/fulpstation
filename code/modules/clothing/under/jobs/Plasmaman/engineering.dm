...
/obj/item/clothing/under/plasmaman/atmospherics
	...
	desc = "An air-tight suit designed to be used by plasmamen employed as atmospheric technicians, the usual purple stripes being replaced by atmos's blue."
	icon_state = "atmos_envirosuit"
	item_state = "atmos_envirosuit"

/obj/item/clothing/under/plasmaman/ce
	name = "CE plasma envirosuit"
	desc = "An air-tight suit designed to be used by plasmamen employed as the chief engineer, the usual purple stripes being replaced by chief engineer's infinitely better yellow."
