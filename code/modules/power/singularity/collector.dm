...
/obj/machinery/power/rad_collector/process()
	...
	if(!bitcoinmining)
		...
		if(!loaded_tank.air_contents.gases[/datum/gas/tritium] || !loaded_tank.air_contents.gases[/datum/gas/oxygen])
			...
			SSresearch.science_tech.add_point_type(TECHWEB_POINT_TYPE_GENERIC, bitcoins_mined*RAD_COLLECTOR_MINING_CONVERSION_RATE*PUBLIC_TECHWEB_GAIN)
			SSresearch.science_tech.add_point_type(TECHWEB_POINT_TYPE_ENGINEERING, bitcoins_mined*RAD_COLLECTOR_MINING_CONVERSION_RATE*PUBLIC_TECHWEB_GAIN)
