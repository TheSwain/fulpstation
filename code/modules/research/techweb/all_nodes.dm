...
/datum/techweb_node/ai
	...
	"default_module", "crewimov_module", "borg_ai_control", "mecha_tracking_ai_control", "aiupload", "intellicard") //FULPSTATION CREWIMOV AI MODULE by Surrealistik April 2020
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 5000
