...
/datum/uplink_item/role_restricted/brainwash_disk
	...
	restricted_roles = list("Medical Doctor", "Chief Medical Officer", "Roboticist", "Cybersun Infiltrator") //FULP - Infiltration Mode.
	cost = 5
...
/datum/uplink_item/role_restricted/laser_arm
	...
	restricted_roles = list("Roboticist", "Cybersun Infiltrator") //FULP - Infiltration Mode.
