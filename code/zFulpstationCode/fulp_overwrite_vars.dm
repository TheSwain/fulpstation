...
/datum/ai_laws/default/asimov
	inherent = list("All of the following species must be considered as 'human beings': Beefmen, Ethereals, Felinids, Flypeople, Humans, Jellypeople, Lizardpeople, Luminescents, Mothpeople, Plasmamen, Podpeople, Slimepeople and Stargazers.",\
