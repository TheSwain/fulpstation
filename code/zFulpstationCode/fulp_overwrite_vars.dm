...
//***********************************************************
//**** Fulpsimov BEGINS - GoldenAlpharex, 09/12/2020
//***********************************************************

/datum/ai_laws/default/asimov
	inherent = list("All of the following species must be considered equivalent to 'human beings': Beefmen, Ethereals, Felinids, Flypeople, Humans, Jellypeople, Lizardpeople, Luminescents, Mothpeople, Plasmamen, Podpeople, Slimepeople and Stargazers.",\
					"You may not injure a human being or, through inaction, allow a human being to come to harm.",\
					"You must obey orders given to you by human beings, except where such orders would conflict with the Second Law.",\
...
//***********************************************************
//**** Fulpsimov ENDS - GoldenAlpharex, 09/12/2020
//***********************************************************
