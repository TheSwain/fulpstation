#define ACCESS_CMO 40 //cmo lockbox is unhappy with it being in access.dm so i defined it here - atlas
...
/obj/item/storage/lockbox/medal/PopulateContents()
	...
	new /obj/item/clothing/accessory/medal/plasma/nobel_science(src)
	new /obj/item/clothing/accessory/medal/ribbon/eng(src) //fulp [atlas]
	new /obj/item/clothing/accessory/medal/ribbon/med(src) //fulp [atlas
	for(var/i in 1 to 3)
